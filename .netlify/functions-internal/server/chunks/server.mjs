...
const _routes = [
  {
    ...
    component: () => import('./index.40badee6.mjs').then((m) => m.default || m)
  }
];
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import('./error-component.0cfedb3c.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
