...
const _routes = [
  {
    ...
    component: () => import('./index.4e9ba7a3.mjs').then((m) => m.default || m)
  }
];
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import('./error-component.09119720.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
