...
const _routes = [
  {
    ...
    component: () => import('./index.8aa05699.mjs').then((m) => m.default || m)
  }
];
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import('./error-component.e233ed90.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
