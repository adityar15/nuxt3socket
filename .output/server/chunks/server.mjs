...
const _routes = [
  {
    ...
    component: () => import('./index.492e3052.mjs').then((m) => m.default || m)
  }
];
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import('./error-component.08781f4d.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
