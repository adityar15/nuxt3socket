...
const _routes = [
  {
    ...
    component: () => import('./index.f7bc11b0.mjs').then((m) => m.default || m)
  }
];
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import('./error-component.efa0e347.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
